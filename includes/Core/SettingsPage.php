    ...
    public function get_settings(): array
    {
        $settings = \apply_filters('woo_tweaks_tools_settings', [
            ...
            [
                ...
                'type'     => 'checkbox',
                'default'  => 'no',
                'desc'     => \__('Afficher des messages d\'urgence personnalisés pour les stocks faibles.', 'woo-tweaks-tools'),
            ],
            [
                'title'    => \__('Seuil d\'urgence (Stock)', 'woo-tweaks-tools'),
                'id'       => 'woo_tweaks_smart_stock_threshold',
                'type'     => 'number',
                'default'  => '10',
                'desc'     => \__('Affiche le message si le stock est inférieur ou égal à ce nombre.', 'woo-tweaks-tools'),
                'custom_attributes' => ['min' => 1, 'step' => 1],
            ],
            [
                'title'    => \__('Modèle de message', 'woo-tweaks-tools'),
